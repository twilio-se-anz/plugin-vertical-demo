...
class PersonalLoanTimeline extends React.Component {
    render() {
      return (
        <VerticalTimeline>
            <VerticalTimelineElement
                ...
                iconStyle={{ background: 'rgb(42,46,66)', color: '#fff' }}
            ...
            <VerticalTimelineElement
                className="vertical-timeline-element--work"
                contentStyle={{ background: 'rgb(42,46,66)', color: '#fff' }}
...
export default withTaskContext(PersonalLoanTimeline);
